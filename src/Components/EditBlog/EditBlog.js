...
const EditBlog = ({ blogDetail, onCancel, onSubmit }) => {
  ...
  <div className="bg-white p-4 rounded-lg shadow-lg m-4 ">
    ...
    <form onSubmit={handleSubmit} className="px-4 py-2 space-y-4">
        ...
        <div className="flex-1 flex flex-col">
          ...
          <div className="flex items-center space-x-2">
            <input
              ...
              className="py-2 w-auto px-3 bg-white text-sm text-gray-900 border border-gray-300 rounded-md focus:outline-none focus:border-blue-600"
      ...
      <button
          onClick={onCancel}
          className="bg-red-500 text-white px-4 py-2 rounded-md hover:bg-blue-600 focus:outline-none focus:bg-blue-600"
        >
          Cancel
        </button>
        <button
