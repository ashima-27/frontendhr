...
function MenuBar({currentRouteName,toggleSidebar,isSidebarVisible}) {
  ...
  return (
    ...
    <header className={` bg-white shadow-md p-4 flex flex-row items-center justify-between fixed top-0  right-0 z-10  ${isSidebarVisible ? "lg:w-full lg:ml-20" :"lg:w-11/12 lg:ml-10 "}`}>
